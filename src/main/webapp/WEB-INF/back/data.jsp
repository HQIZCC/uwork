...
<head>
    ...
    <link rel="shortcut icon" href="${ctx}/backfile/../../backfile/img/favicon.ico"> <link href="${ctx}/backfile/css/bootstrap.min14ed.css?v=3.3.6" rel="stylesheet">
    <link href="${ctx}/backfile/css/font-awesome.min93e3.css?v=4.4.0" rel="stylesheet">

    <!-- Morris -->
    <link href="${ctx}/backfile/css/plugins/morris/morris-0.4.3.min.css" rel="stylesheet">

    <!-- Gritter -->
    <link href="${ctx}/backfile/js/plugins/gritter/jquery.gritter.css" rel="stylesheet">
...
<body class="gray-bg">
                        ...
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                <ul class="todo-list m-t small-list ui-sortable">
                                    <li>
                                        <a href="${ctx}/backfile/widgets.html#" class="check-link"><i class="fa fa-check-square"></i> </a>
                                    ...
                                    <li>
                                        <a href="${ctx}/backfile/widgets.html#" class="check-link"><i class="fa fa-square-o"></i> </a>
    ...
    <script src="${ctx}/backfile/js/plugins/flot/jquery.flot.js"></script>
    <script src="${ctx}/backfile/js/plugins/flot/jquery.flot.tooltip.min.js"></script>
    <script src="${ctx}/backfile/js/plugins/flot/jquery.flot.spline.js"></script>
    <script src="${ctx}/backfile/js/plugins/flot/jquery.flot.resize.js"></script>
    <script src="${ctx}/backfile/js/plugins/flot/jquery.flot.pie.js"></script>
    <script src="${ctx}/backfile/js/plugins/flot/jquery.flot.symbol.js"></script>
    <script src="${ctx}/backfile/js/plugins/peity/jquery.peity.min.js"></script>
    <script src="${ctx}/backfile/js/demo/peity-demo.min.js"></script>
    <script src="${ctx}/backfile/js/content.min.js?v=1.0.0"></script>
    <script src="${ctx}/backfile/js/plugins/jquery-ui/jquery-ui.min.js"></script>
    <script src="${ctx}/backfile/js/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
    <script src="${ctx}/backfile/js/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
    <script src="${ctx}/backfile/js/plugins/easypiechart/jquery.easypiechart.js"></script>
    <script src="${ctx}/backfile/js/plugins/sparkline/jquery.sparkline.min.js"></script>
    <script src="${ctx}/backfile/js/demo/sparkline-demo.min.js"></script>
    <script>
