...
<head>
    ...
    <title>UWork 活动日历</title>
    <meta name="keywords" content="日历">
    <meta name="description" content="日历">

    <link rel="shortcut icon" href="${ctx}/backfile/img/favicon.ico"> <link href="${ctx}/backfile/css/bootstrap.min14ed.css?v=3.3.6" rel="stylesheet">
    <link href="${ctx}/backfile/css/font-awesome.min93e3.css?v=4.4.0" rel="stylesheet">

    <link href="${ctx}/backfile/css/plugins/iCheck/custom.css" rel="stylesheet">

    <link href="${ctx}/backfile/css/plugins/fullcalendar/fullcalendar.css" rel="stylesheet">
    <link href="${ctx}/backfile/css/plugins/fullcalendar/fullcalendar.print.css" rel="stylesheet">
...
<body class="gray-bg">
            ...
            <div class="col-sm-3">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        ...
                        <div class="ibox-tools">
                            ...
                            <a class="dropdown-toggle" data-toggle="dropdown" href="${ctx}/backfile/calendar.html#">
                                <i class="fa fa-wrench"></i>
                            </a>
                            <ul class="dropdown-menu dropdown-user">
                                <li><a href="${ctx}/backfile/calendar.html#">选项1</a>
                                </li>
                                <li><a href="${ctx}/backfile/calendar.html#">选项2</a>
                                </li>
                            </ul>
                            <a class="close-link">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-content">
                        ...
                        <p>
                            <a href="${ctx}/backfile/http://arshaw.com/fullcalendar/" target="_blank">FullCalendar开发文档</a>
                        </p>
                    </div>
                </div>
            </div>
    ...
    <script src="${ctx}/backfile/js/jquery-ui.custom.min.js"></script>
    <script src="${ctx}/backfile/js/plugins/iCheck/icheck.min.js"></script>
    <script src="${ctx}/backfile/js/plugins/fullcalendar/fullcalendar.min.js"></script>
    <script>
